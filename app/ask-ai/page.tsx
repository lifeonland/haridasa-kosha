    ...
    <main className="min-h-screen bg-slate-50 py-16 px-6">
      <div className="max-w-3xl mx-auto flex flex-col h-[85vh]">
            <div className="text-center space-y-4 mb-12">
                ...
                <Typography variant="h1" className="text-4xl font-bold tracking-tight">{t('navAskAI')}</Typography>
            </div>

            {/* Chat Container */}
            <div className="flex-1 bg-white border border-slate-100 rounded-[2rem] p-6 shadow-xl shadow-slate-100 flex flex-col overflow-hidden">
                ...
                {isLoading && (
                    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="flex gap-4">
                        ...
                        <div className="p-5 rounded-[1.5rem] bg-slate-50 text-slate-400 text-sm">{t('thinking')}</div>
                    </motion.div>
                )}
