...
async function main() {
  console.log('Fixing lyrics for Shiva Shiva Shiva Enniro (kanaka-list-48)...');

  const lyrics = `ಶಿವ ಶಿವ ಶಿವ ಎನ್ನಿರೊ – ಮೂಜಗದವರೆಲ್ಲಶಿವ ಶಿವ ಶಿವ ಎನ್ನಿರೊ ||pa||
...
ಮುಂದೆಉಪಮಿತರೋರ್ಮಿತರರಿಯದ ಜಪವಿದು ಶಿವಶಿವಶಿವ ಎನ್ನಿರೊ||1||
...
ನೀವುತತ್ತ್ವಪತಿ ಆದಿಕೇಶವನ ಕೂಡಬೇಕಾದರೆ ಶಿವಶಿವಶಿವ ಎನ್ನಿರೊ||3||`;
  ...
  console.log('✅ Lyrics fixed successfully!');
}
