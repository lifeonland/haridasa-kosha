...
async function main() {
  ...
  console.log(`Removing composition ${compId} and all dependencies (including DailyComposition)...`);
  ...
  // 3. Delete associated daily compositions (This was the blocking constraint)
